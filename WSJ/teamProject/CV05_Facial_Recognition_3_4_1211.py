...
def dd(video):
    ...
    model =  load_model("./model/CV05_2_3_MCP_1214-23-3.8027.hdf5")
    ...
    saveFilePath = './teamProject/video/otter_out.avi'
    ...
    out = cv2.VideoWriter(saveFilePath, fourcc, 20.0, (int(width), int(height))) # VideoWriter 객체 정의
