...
def load_ImageData():
    ...
    suzy_image = face_recognition.load_image_file("./teamProject/dlib_images/suzy.jpg")
    suzy_face_encoding = face_recognition.face_encodings(suzy_image)[0]

    # Load a second sample picture and learn how to recognize it.
    juhyuk_image = face_recognition.load_image_file("./teamProject/dlib_images/Juhyuk.jpg")
    juhyuk_face_encoding = face_recognition.face_encodings(juhyuk_image)[0]

    sunho_image = face_recognition.load_image_file("./teamProject/dlib_images/sunho.jpg")
    sunho_face_encoding = face_recognition.face_encodings(sunho_image)[0]

    hanna_image = face_recognition.load_image_file("./teamProject/dlib_images/hanna.jpg")
...
def Dlib(video_capture, empty_list, data_list):
        ...
        cv2.putText(frame,"Dlib",(750,50), cv2.FONT_HERSHEY_COMPLEX,1, (0, 255, 0), 2)
